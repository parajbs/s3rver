...
program
  ...
  .option(
    '-l, --logfile true/false',
    'Enable to create a log in tmp/logfiles/console.log (default=false)',
    S3rver.defaultOptions.logfile,
  )
  .option(
    '--key <path>',
  ...
  .option(
    ...
    'AccountID default 123456789000',
    S3rver.defaultOptions.defaultAccountId,
  )
  .option(
    '--default-account-key-id <accountDisplayName>',
    'AccountDisplayName default S3rver',
    S3rver.defaultOptions.defaultAccountDisplayName,
  )
  .option(
  ...
  .option(
    '--private-buckets true/false',
    'false = S3rver runs as default a public bucket!',
    S3rver.defaultOptions.privatebuckets,
  )
